...
export const vocabularyCategories: VocabularyCategory[] = [
  ...
  },
  {
    ...
    words: [
      ...
      { id: "fd5", english: "Restaurant", spanish: "Restaurante", pronunciation: "/ˈrestərɒnt/", example: "Let's go to that new restaurant.", exampleTranslation: "Vamos a ese nuevo restaurante.", mastered: false },
    ]
  },
  {
    id: "travel",
  ...
  },
  {
    ...
    words: [
      ...
      { id: "w3", english: "Colleague", spanish: "Colega", pronunciation: "/ˈkɒliːɡ/", example: "My colleague helped me with the project.", exampleTranslation: "Mi colega me ayudó con el proyecto.", mastered: false },
      ...
      { id: "w5", english: "Interview", spanish: "Entrevista", pronunciation: "/ˈɪntərvjuː/", example: "I have a job interview tomorrow.", exampleTranslation: "Tengo una entrevista de trabajo mañana.", mastered: false },
    ]
  },
  {
    id: "health",
    ...
    words: [
      ...
      { id: "h5", english: "Exercise", spanish: "Ejercicio", pronunciation: "/ˈeksərsaɪz/", example: "I exercise three times a week.", exampleTranslation: "Hago ejercicio tres veces por semana.", mastered: false },
    ]
  },
  {
    id: "shopping",
    ...
    level: "A2",
    words: [
      { id: "s1", english: "Price", spanish: "Precio", pronunciation: "/praɪs/", example: "What's the price of this shirt?", exampleTranslation: "¿Cuál es el precio de esta camisa?", mastered: false },
  ...
  },
  {
    ...
    words: [
      ...
      { id: "tech2", english: "Download", spanish: "Descargar", pronunciation: "/ˌdaʊnˈloʊd/", example: "You can download the app for free.", exampleTranslation: "Puedes descargar la aplicación gratis.", mastered: false },
